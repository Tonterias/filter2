...
import com.filter.web.config.audit.AuditEventConverter;
import com.filter.web.domain.PersistentAuditEvent;
...
import static com.filter.web.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
